...
//        pElmt->data = pInt;
        ...
        std::cout<< "Inserting into list" << *pInt << std::endl;
    ...
    while(pElmt != NULL){
        pInt = (int *)list_is_data(pElmt);
        std::cout<<"This is the data stored int *pInt: " << *pInt<<'\n';
        pElmt = list_next(pElmt);
    }
    printf("\n");
    /*Destroy the list (This automatically calls destroyInt on each data)*/
